...
Sincerely, Security Department`,
  ...
  {
    label: "ML · അക്കൗണ്ട് സുരക്ഷ",
    text: `അക്കൗണ്ടില് അനധികൃതമായി പ്രവേശിച്ചു ₹25,000 അനുമതിയില്ലാതെ ട്രാന്സഫര് ചെയ്തു. ദയവായി ഉടനെ സഹായിക്കൂ, എന്റെ അക്കൗണ്ട് സുരക്ഷിക്കുക.`,
  },
  {
    label: "ML · ഫിഷിംഗ് അക്കൗണ്ട് പരീക്ഷ",
    text: `പ്രിയ ഉപഭോക്താവ്, അക്കൗണ്ടില് അസാധാരണ പ്രവര്ത്തനം കണ്ടെത്തി. അക്കൗണ്ട് സുരക്ഷിക്കാന് 24 മണിക്കൂറിനുള്ളില് ഇവിടെ ക്ലിക്ക് ചെയ്യൂ: http://paypa1-സുരക്ഷ.example/login`,
  },
];
