...
const ml: UIStrings = {
  ...en,
  tagline: "കസ്റ്റമർ സപ്പോർട്ട് ഇന്റലിജൻസും ഫിഷിംഗ് ഭീഷണി കണ്ടെത്തലും",
  console: "കൺസോൾ",
  ...
  settingsDesc: "Threatly നിങ്ങളുടെ സംഭാഷണങ്ങൾ എങ്ങനെ വിശ്ലേഷിക്കുന്നുവെന്ന് ക്രമീകരിക്കുക.",
  languageSection: "വിശ്ലേഷണ ഭാഷ",
  languageDesc:
    "ഓരോ സന്ദേശത്തിന്റെയും ഭാഷ സ്വയം തിരിച്ചറിയാൻ ഓട്ടോ-ഡിറ്റക്ട് തിരഞ്ഞെടുക്കാം, അല്ലെങ്കിൽ ഒരു ഭാഷ നിശ്ചയിച്ചാൽ എല്ലാ സന്ദേശങ്ങളും ആ ഭാഷയിൽ വിശ്ലേഷിക്കപ്പെടും.",
  autoDetect: "ഓട്ടോ-ഡിറ്റക്ട്",
  autoDetectDesc: "ഓരോ സന്ദേശത്തിന്റെയും ഭാഷ സ്വയം തിരിച്ചറിയുന്നു (വ്യക്തമല്ലെങ്കിൽ ഇംഗ്ലീഷ്).",
  currentPref: "നിലവിലെ ക്രമീകരണം",
  prefApplied: "ഈ ക്രമീകരണം ഈ ഉപകരണത്തിൽ സൂക്ഷിക്കുകയും ഓരോ പുതിയ വിശ്ലേഷണത്തിലും ബാധിക്കുകയും ചെയ്യും.",
  engineSection: "വിശ്ലേഷണ എഞ്ചിൻ",
  engineTitle: "നിയമ-അധിഷ്ഠിത ഇന്റലിജൻസ് എഞ്ചിൻ",
  engineDesc:
    "വർഗ്ഗീകരണം, വികാരം, സംഗ്രഹം, URL/അയച്ചയാൾ പരിശോധന, സോഷ്യൽ-എഞ്ചിനീയറിംഗ് കണ്ടെത്തൽ എന്നിവ പൂർണ്ണമായും നിങ്ങളുടെ ബ്രൗസറിൽ പ്രവർത്തിക്കുന്നു — ഡാറ്റ ഈ ഉപകരണത്തിൽ നിന്ന് പുറത്തുപോകുന്നില്ല.",
  engineOn: "സജീവം",
  analyzeTitle: "ഒരു സംഭാഷണം വിശ്ലേഷിക്കുക",
  analyzeDesc:
    "കസ്റ്റമർ ഇമെയിൽ, ചാറ്റ് അല്ലെങ്കിൽ ടിക്കറ്റ് പേസ്റ്റ് ചെയ്യുക — ഒരു തവണയിൽ സപ്പോർട്ട് ഇന്റലിജൻസും ഫിഷിംഗ് വിധിയും നേടുക.",
  inputPlaceholder: "കസ്റ്റമർ സന്ദേശം ഇവിടെ പേസ്റ്റ് ചെയ്യുക…",
  domainPlaceholder: "നിങ്ങളുടെ സ്ഥാപനത്തിന്റെ ഡൊമെയ്ൻ (ഉദാ. acme.com) — അയച്ചയാളുടെ പരിശോധന മെച്ചപ്പെടുത്തുന്നു",
  analyzeMessage: "സന്ദേശം വിശ്ലേഷിക്കുക",
  reset: "റീസെറ്റ്",
  heroSubtitle:
    "Threatly കസ്റ്റമർ ഇമെയിലുകൾ, ചാറ്റുകൾ, ടിക്കറ്റുകൾ വിശ്ലേഷിച്ച് പരാതി വർഗ്ഗീകരണം, വികാരം, ആവർത്തിക്കുന്ന പ്രശ്നങ്ങൾ വേർതിരിച്ചെടുക്കുന്നു — അതേ സംഭാഷണത്തിൽ ഫിഷിംഗ് URL-കൾ, നുള്ളിപ്പറയുന്ന അയച്ചയാൾ, സോഷ്യൽ-എഞ്ചിനീയറിംഗ് ആക്രമണങ്ങൾ കണ്ടെത്തുന്നു.",
};

export const UI_TRANSLATIONS: Record<SupportedLang, UIStrings> = { en, es, fr, de, pt, hi, ml };
